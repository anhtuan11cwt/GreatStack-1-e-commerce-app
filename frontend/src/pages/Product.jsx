...
const Product = () => {
  ...
  return (
    <div className="flex flex-col gap-12 border-t pt-10 sm:flex-row sm:gap-12">
      ...
      <div className="flex-1">
        ...
        <button
          className="mt-8 flex w-full cursor-pointer items-center justify-center gap-2 bg-black py-3 text-white text-sm active:bg-gray-700 sm:w-1/2"
          type="button"
        >
